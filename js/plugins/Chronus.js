...
(function () {
  ...
  Game_Interpreter.prototype.setSwitchTimer = function (args) {
    ...
    $gameSystem
      .chronus()
      .makeTimer(args.name || null, args.timeout, switchKey, args.loop);
  };
  ...
  Game_Interpreter.prototype.getSwitchKey = function (switchId, selfSwitchId) {
    return selfSwitchId
      ? [$gameMap.mapId(), this.eventId(), selfSwitchId.toUpperCase()]
      : switchId;
  };
  ...
  Window_Chronus.prototype.initialize = function () {
    _Window_Chronus_initialize.call(
      this,
      new Rectangle(0, 0, this.getDefaultWidth(), this.getDefaultHeight())
    );
    this.createContents();
  ...
  var _Window_Chronus_resetFontSettings =
    Window_Chronus.prototype.resetFontSettings;
  ...
  Window_Chronus.prototype.refresh = function () {
    ...
    this.drawTextEx(
      ...
      0,
      height + paramCalendarLineSpacing + padding
    );
    this.update();
  };
