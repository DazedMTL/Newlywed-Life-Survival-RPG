...
(function () {
  ...
  Game_Interpreter.prototype.execSetDestinationWithIcon = function (
    destination,
    icon
  ) {
  ...
  //  行動目標ウィンドウを生成します。
  //=============================================================================
  const _Scene_Map_createMapNameWindow =
  ...
  Scene_Menu.prototype.createDestinationWindow = function () {
    this._destinationWindow = new Window_DestinationMenu(
      this.destinationWindowRect()
    );
  ...
  Scene_Menu.prototype.calcDestinationWindowHeight = function () {
    return Window_Destination.prototype.fittingHeight(
      $gameSystem.getDestination().length
    );
  };
