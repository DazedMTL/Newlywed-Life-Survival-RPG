...
// ♦ ALIAS ♦  Init Members
//==============================
var _alias_mog_eventext_cbase_initMembers =
...
// ♦ ALIAS ♦  Initialize
//==============================
var _alias_mog_eventext_schar_initialize =
...
//==============================
var _alias_mog_eventext_srmap_createLowerLayer =
...
Sprite_CharText.prototype.create_char_text = function () {
  ...
  if (this.character()._char_text[1] === "") {
    return;
  }
...
Sprite_CharText.prototype.textY_axis = function () {
  return (
    -(this.sprite_char.patternHeight() + 24) +
    Moghunter.charText_y +
    this.sprite_char.y
  );
};
