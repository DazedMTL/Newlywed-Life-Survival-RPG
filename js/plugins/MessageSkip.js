...
(function () {
  ...
  var paramPictureOutOfPressing = getParamBoolean([
    "PictureOutOfPressing",
    "ピクチャは押し続け対象外",
  ]);
  ...
  Window_Message.prototype.setSkipAutoFlagByTrigger = function () {
    if (this.isTriggeredMessageSkip()) {
      ...
      paramPressingSkip &&
      (!this._pressSkipStop || !paramPictureOutOfPressing)
    ) {
      $gameMessage.setSkipFlg(
        this.isPressedMessageSkip() || this.isTriggeredMessageSkipButton(true)
      );
    }
  };
