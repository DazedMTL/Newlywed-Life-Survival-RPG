...
(() => {
  ...
  params.PartyCommandPosition =
    eval(parameters["PartyCommandPosition"]) || "top";
  params.PartyCommandWindowSkin = String(parameters["PartyCommandWindowSkin"]);
  params.PartyCommandWindowColor = (NUUN_Base_Ver >= 113
    ? DataManager.nuun_structureData(parameters["PartyCommandWindowColor"])
    : null) || { red: "0", green: "0", bule: "0" };
  ...
  params.PartyCommandWindowShow = eval(
    parameters["PartyCommandWindowShow"] || "true"
  );
  params.PartyCommandWindowCenter = eval(
    parameters["PartyCommandWindowCenter"] || "true"
  );
  params.PartyCommandBackgroundImg = String(
    parameters["PartyCommandBackgroundImg"]
  );
  ...
  params.ActorCommandPosition =
    eval(parameters["ActorCommandPosition"]) || "actor";
  params.ActorCommandWindowSkin = String(parameters["ActorCommandWindowSkin"]);
  params.ActorCommandWindowColor = (NUUN_Base_Ver >= 113
    ? DataManager.nuun_structureData(parameters["ActorCommandWindowColor"])
    : null) || { red: "0", green: "0", bule: "0" };
  params.ActorCommand_Width = Number(parameters["ActorCommand_Width"] || 192);
  params.ActorCommandVariable = eval(
    parameters["ActorCommandVariable"] || "true"
  );
  ...
  params.ActorCommandWindowShow = eval(
    parameters["ActorCommandWindowShow"] || "true"
  );
  params.ActorCommandWindowCenter = eval(
    parameters["ActorCommandWindowCenter"] || "true"
  );
  params.ActorCommandBackgroundImg = String(
    parameters["ActorCommandBackgroundImg"]
  );
  ...
  params.EnemyWindowBackgroundImg = String(
    parameters["EnemyWindowBackgroundImg"]
  );
  params.EnemyWindowBackground_X = Number(
    parameters["EnemyWindowBackground_X"] || 0
  );
  params.EnemyWindowBackground_Y = Number(
    parameters["EnemyWindowBackground_Y"] || 0
  );

  params.ActorStatusWindowSkin = String(parameters["ActorStatusWindowSkin"]);
  params.ActorStatusWindowColor = (NUUN_Base_Ver >= 113
    ? DataManager.nuun_structureData(parameters["ActorStatusWindowColor"])
    : null) || { red: "0", green: "0", bule: "0" };
  params.ActorStatusVariable = eval(
    parameters["ActorStatusVariable"] || "false"
  );
  ...
  params.ActorStatusWindowPosition =
    eval(parameters["ActorStatusWindowPosition"]) || "under";
  ...
  params.ActorStatusWindow_Width = Number(
    parameters["ActorStatusWindow_Width"] || 0
  );
  params.ActorStatusWindow_Height = Number(
    parameters["ActorStatusWindow_Height"] || 0
  );
  params.ActorStatusWindowCenter = eval(
    parameters["ActorStatusWindowCenter"] || "false"
  );
  ...
  params.DefaultStatusPositionData =
    (NUUN_Base_Ver >= 113
      ? DataManager.nuun_structureData(parameters["DefaultStatusPositionData"])
      : null) || {};
  params.DefaultActorImgData =
    (NUUN_Base_Ver >= 113
      ? DataManager.nuun_structureData(parameters["DefaultActorImgData"])
      : null) || {};
  params.ActorData =
    (NUUN_Base_Ver >= 113
      ? DataManager.nuun_structureData(parameters["ActorData"])
      : null) || [];
  ...
  params.OutsideWindowVisible = eval(
    parameters["OutsideWindowVisible"] || "false"
  );
  params.SelectBackShow = eval(parameters["SelectBackShow"] || "true");
  params.ActorSelectBackShow = eval(
    parameters["ActorSelectBackShow"] || "true"
  );
  ...
  params.AppearWindowVisible = eval(
    parameters["AppearWindowVisible"] || "false"
  );
  params.AppearWindowOpacity = Number(parameters["AppearWindowOpacity"] || 255);
  params.AppearWindowAnchorMode =
    eval(parameters["AppearWindowAnchorMode"]) || "under";
  ...
  params.ItemWindowBackgroundImg = String(
    parameters["ItemWindowBackgroundImg"]
  );
  ...
  params.SkillWindowBackgroundImg = String(
    parameters["SkillWindowBackgroundImg"]
  );
  ...
  params.HelpWindowBackgroundImg = String(
    parameters["HelpWindowBackgroundImg"]
  );
  params.HelpBackground_X = Number(parameters["HelpBackground_X"] || 0);
  params.HelpBackground_Y = Number(parameters["HelpBackground_Y"] || 0);

  params.VictoryWindowAnchorMode =
    eval(parameters["VictoryWindowAnchorMode"]) || "under";
  params.VictoryWindowOpacity = Number(
    parameters["VictoryWindowOpacity"] || 255
  );
  ...
  params.LoseWindowAnchorMode =
    eval(parameters["LoseWindowAnchorMode"]) || "under";
  ...
  params.EscapeWindowAnchorMode =
    eval(parameters["EscapeWindowAnchorMode"]) || "under";
  ...
  params.EscapeFailureBackgroundImg = String(
    parameters["EscapeFailureBackgroundImg"]
  );
  params.EscapeFailureBackground_X = Number(
    parameters["EscapeFailureBackground_X"] || 0
  );
  params.EscapeFailureBackground_Y = Number(
    parameters["EscapeFailureBackground_Y"] || 0
  );

  params.MessageWindowOpacity = Number(
    parameters["MessageWindowOpacity"] || 255
  );

  params.SupportActorCommand_X = Number(
    parameters["ESupportActorCommand_X"] || 0
  );
  params.SupportActorCommand_Y = Number(
    parameters["SupportActorCommand_Y"] || 0
  );
