...
(function () {
  ...
  function readParameter() {
    ...
    return {
      version: "1.3.2",
      basePosition: pickStringValueFromParameter(
        parameter,
        "basePosition",
        "top"
      ),
      ...
      customizeCondition: pickStringValueFromParameter(
        parameter,
        "customizeCondition",
        "always"
      ),
      customizeGaugeWidth: pickIntegerValueFromParameter(
        parameter,
        "customizeGaugeWidth",
        100
      ),
      customizeGaugeHeight: pickIntegerValueFromParameter(
        parameter,
        "customizeGaugeHeight",
        10
      ),
      customizeDrawLabel: pickBooleanValueFromParameter(
        parameter,
        "customizeDrawLabel",
        "true"
      ),
      customizeLabelWidth: pickIntegerValueFromParameter(
        parameter,
        "customizeLabelWidth",
        20
      ),
      customizeLabelFontSize: pickIntegerValueFromParameter(
        parameter,
        "customizeLabelFontSize",
        16
      ),
      customizeValueFontSize: pickIntegerValueFromParameter(
        parameter,
        "customizeValueFontSize",
        20
      ),
      customizeMaskHpValue: pickStringValueFromParameter(
        parameter,
  ...
  function hpBarX(enemy) {
    return parseInt(
      (enemy && (enemy.meta["hpBarPosX"] || enemy.meta["HPバーX"])) || 0,
      10
    );
  }
  ...
  function hpBarY(enemy) {
    return parseInt(
      (enemy && (enemy.meta["hpBarPosY"] || enemy.meta["HPバーY"])) || 0,
      10
    );
  }
  ...
  function hpBarWidth(enemy) {
    return parseInt(
      (enemy && (enemy.meta["hpBarWidth"] || enemy.meta["HPバー幅"])) || 0,
      10
    );
  }
  ...
  function hpBarHeight(enemy) {
    return parseInt(
      (enemy && (enemy.meta["hpBarHeight"] || enemy.meta["HPバー高さ"])) || 0,
      10
    );
  }
  ...
  function isShowHpValueOfBattler(a) {
    ...
    const enemy = a.enemy();
    const code =
      enemy.meta["hpShowCondition"] || enemy.meta["HP表示条件"] || "";
    if (!code) return true;
    try {
  ...
  class Sprite_EnemyHpGauge extends Sprite_Gauge {
    ...
    gaugeWidth() {
      return (
        hpBarWidth(this._battler && this._battler.enemy()) ||
        Torigoya.EnemyHpBar.parameter.customizeGaugeWidth
      );
    }
    ...
    drawMaskValue() {
      ...
      this.bitmap.drawText(
        Torigoya.EnemyHpBar.parameter.customizeMaskHpValue,
        0,
        0,
        width,
        height,
  ...
  (() => {
    const upstream_Sprite_Enemy_initMembers =
    ...
    Sprite_Enemy.prototype.torigoyaEnemyHpBar_createGaugeSprite = function () {
      this._torigoyaEnemyHpBar_gaugeSprite =
        new Torigoya.EnemyHpBar.Sprite_EnemyHpGauge();
    ...
    Sprite_Enemy.prototype.torigoyaEnemyHpBar_updateGaugeSprite = function () {
      ...
      this._torigoyaEnemyHpBar_gaugeSprite.opacity +=
        this._torigoyaEnemyHpBar_gaugeSprite.shouldShow() ? 48 : -48;
    };
